		...
		<view class="formcontent">
			<form>
				...
				<view class="cu-form-group">
					...
					<input placeholder="姓名" v-model="form.result3" name="input"></input>
				</view>
				<view class="cu-form-group">
					<view class="title">电话</view>
					<input placeholder="电话" v-model="form.result4" name="input"></input>
				</view>
				<view class="cu-form-group">
					<view class="title">被访用户</view>
				...
				<view class="cu-form-group">
					...
					<input placeholder="天" v-model="form.result7" name="input"></input>
				</view>
				...
				<view class="cu-form-group">
					...
					<textarea maxlength="-1" v-model="form.result8" placeholder=" "></textarea>
				</view>
			</form>
