		...
		<view class="formcontent">
			<form>
				...
				<view class="cu-form-group">
					...
					<input placeholder="标题" v-model="form.result3" name="input"></input>
				</view>
				...
				<view class="cu-form-group">
					...
					<textarea maxlength="-1" v-model="form.result4" placeholder=" "></textarea>
				</view>
			</form>
		...
		methods: {
			...
			async submit() {
				...
				let obj = {
					...
					result1: '报修',
					result2: this.picker[this.index],
