                ...
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="内容" prop="detail">
                            <el-input type="textarea" :rows="5" v-model="form.detail" placeholder="请输入内容">
                            </el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
import { queryfloor, addfloor, updatafloor, updatafloorstatus, removefloor, saveactivityexcel } from '@/api/sysapi'
...
export default {
    ...
    methods: {
        ...
        changestatus(index, row) {
            ...
            updatafloorstatus(objedit).then(res => {
                this.query()
                this.$message.success('操作成功')
            }).catch(error => {
                // this.$message.error('操作失败')
        ...
        downloadExl(data, type) {
            ...
            let wopts = { bookType: 'xlsx', bookSST: false, type: 'binary' };//这里的数据是用来定义导出的格式
            console.log(wopts)
