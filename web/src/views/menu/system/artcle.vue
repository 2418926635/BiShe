                ...
                <div class="demo-user-search">
                    <el-row :gutter="20">
                        ...
                        <!-- <el-col :md="6" :lg="6">
                            <div class="demo-input-suffix">
                                精选：
                                <el-select clearable v-model="search.goodstatus" placeholder="请选择" class="search-user">
                ...
                <div class="demo-user-contentfu">
                    ...
                    <div class="demo-user-page">
                        <el-table :header-cell-style="headerstyle" ref="multipleTable" :data="tableData" height="500"
                            ...
                            <!-- <el-table-column label="是否精选" width="130">
                                <template slot-scope="scope">
                                    <el-switch v-model="scope.row.goodstatus" active-color="#13ce66"
...
<script>
import { chatremove,queryannouncement, queryarticle, deletearticle, addtask, updatasubmitdata, updatataskstatus, querychatart, saveactivityexcel } from '@/api/sysapi'
    ...
    methods: {
        ...
        query() {
            ...
            let obj = {
                ...
                goodstatus: this.search.goodstatus,
                userid: 0
            }
            // this.pendingflag = true
            queryarticle(obj).then(res => {
                this.tableData = res.map((val, i) => {
                    val.goodstatus = val.goodstatus == '是' ? true : false
                    if (val.trans_pic) {
        ...
        chatDelete(id) {
            let that = this
            this.$confirm('此操作将永久删除该评论以及子评论, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                let obj = { id: id }
                chatremove(obj).then(res => {
                    that.querychatfun()
