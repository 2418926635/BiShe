                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <div class="demo-input-suffix">
                                户主姓名：
                                <el-input placeholder="请输入内容" v-model="search.result4" class="search-user">
                                </el-input>
                            </div>
                        </el-col>
                        <el-col :span="4">
...
<script>
import { querybasemsg, insertbasemsg, updatebasemsg, updatebasemsgstatus, basemsgremove } from '@/api/sysapi'
...
export default {
    ...
    data() {
        return {
            ...
            griddata: [
                { prop: 'datetime', label: '缴费时间', width: '' },
                // { prop: 'result1', label: 'result1', width: '200' },
                { prop: 'result2', label: '缴费类型', width: '' },
                { prop: 'result3', label: '户号', width: '' },
                { prop: 'result4', label: '户主姓名', width: '' },
                { prop: 'result5', label: '缴费金额', width: '' },
