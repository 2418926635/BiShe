                ...
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="反馈" prop="title">
                            <el-select v-model="form.result10" placeholder="请选择">
...
export default {
    ...
    data() {
        return {
            ...
            griddata: [
                { prop: 'datetime', label: '提交时间', width: '' },
                // { prop: 'result1', label: 'result1', width: '200' },
                { prop: 'result3', label: '姓名', width: '' },
                { prop: 'result4', label: '电话', width: '' },
                { prop: 'result5', label: '被访用户', width: '' },
                { prop: 'result6', label: '房间号', width: '200' },
                { prop: 'result7', label: '访问时间', width: '200' },
                { prop: 'result8', label: '备注', width: '200' },
                // { prop: 'result9', label: 'result9', width: '200' },
                // { prop: 'result10', label: 'result10', width: '200' },
                { prop: 'userName', label: '提交人', width: '' },
