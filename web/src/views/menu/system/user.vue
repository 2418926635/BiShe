<template>
    <div class="user-main" v-loading="pendingflag">
                        ...
                        <el-col :md="12" :lg="8">
                            <div class="demo-input-suffix">
                                ...
                                <el-select v-model="search.status" placeholder="请选择" class="search-user">
                                    ...
                                    <el-option label="待启用" value="停用"></el-option>
                                </el-select>
                            </div>
                        </el-col>
                        <el-col :md="12" :lg="8">
                ...
                <div class="demo-user-contentfu">
                        ...
                        <el-row class="demo-user-contentbutleft">
                            <el-col :span="10">
                                <div class="demo-user-contentbutleftsub">
                                    <el-button size="mini" type="primary" icon="el-icon-plus" @click="adddata">新增
                                    </el-button>
                    ...
                    <div class="demo-user-page">
                        <el-table border :header-cell-style="{ 'text-align': 'center', 'background-color': '#f1f1f1' }"
                            ...
                            <el-table-column prop="school" label="户号"></el-table-column>
                            <!-- <el-table-column prop="sextext" label="性别"></el-table-column>
                            <el-table-column prop="nl" label="年龄"></el-table-column> -->
                            <el-table-column prop="img" label="产权证明" width="160">
                                <template v-slot="scope">
                                    <div class="receiveclasspic">
                                        <img v-for="(val, i) in scope.row.stu_Arrpic" :key="i" :src="val" alt=""
                            ...
                            <el-table-column label="操作" width="150">
                                <template slot-scope="scope">
                                    ...
                                    <el-tooltip class="item" effect="dark" content="重置密码" placement="top">
                                        <el-button type="warning" icon="el-icon-unlock" circle plain size="mini"
                                            @click="resetpass(scope.$index, scope.row)"></el-button>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
        ...
        <!-- 重置密码 -->
        <el-dialog title="提示" :visible.sync="repassDialogVisible" width="30%" center>
            <span>{{ repassstr }}</span>
        ...
        <!-- 用户信息弹框 -->
        <!-- 添加或修改用户配置对话框 -->
        <el-dialog class="diaitemuser" :title="userinfotitle" :visible.sync="dialoguserVisible" width="600px"
            append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="用户账号" prop="empNo">
                            <el-input v-model="form.empNo" @blur="validempno" placeholder="请输入账号" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <!-- <el-col :span="12">
                        <el-form-item label="年龄" prop="email">
                            <el-input type="number" v-model="form.nl" placeholder="请输入年龄" maxlength="50" />
                        </el-form-item>
                    </el-col> -->
                </el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="户号" prop="mobile">
                            <el-input v-model="form.school" placeholder="请输入户号" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
        ...
        query() {
            ...
            userQueryList(obj).then(res => {
                ...
                this.tableData = arr.map((val, i) => {
                    ...
                    val.sextext = val.sex == 0 ? '男' : '女'
                    if (val.stu_pic) {
                        val.stu_Arrpic = val.stu_pic.split('^^^')
                    }
