                ...
                <el-row :gutter="20">
                    <el-col :span="24">
                        <div class="grid-content bg-purple">
                            <el-form-item label="习题题目" :label-width="formLabelWidth">
                    ...
                    <el-col :span="24">
                        <div class="grid-content bg-purple">
                            <el-form-item label="习题答案" :label-width="formLabelWidth">
                                <el-input type="textarea" :rows="6" placeholder="请输入答案" v-model="form.tmzqda">
                                </el-input>
...
import { questionselect, querysysnews, questionupdata, questionremove, questioninsert } from '@/api/sysapi'
...
export default {
    ...
    methods: {
        ...
        submitoption() {
            let that = this
            //必填校验
            if (this.form.classstr == '' || this.form.title == '') {
                this.$message({
                    type: 'info',
                    message: '有必填字段未填写'
                })
