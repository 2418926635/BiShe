                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="路线名称" prop="title">
                            <el-input v-model="form.title" placeholder="请输入路线名称" />
                        </el-form-item>
                    </el-col>
                    <!-- <el-col :span="24">
                        <el-form-item label="路线图片" prop="trans_pic">
                            <el-upload action="/upload" list-type="picture-card" :on-preview="handlePictureCardPreviewwl"
                                :on-remove="handleRemovewl" :on-success="handleSuccesswl" :file-list="fileListwl">
                    ...
                    <el-col :span="24">
                        <el-form-item label="目的地" prop="mdd">
                            <el-input v-model="form.mdd" placeholder="目的地" />
                        </el-form-item>
                    </el-col>
                    <!-- <el-col :span="24">
                        <el-form-item label="交通方式" prop="jtfs">
                            <el-input v-model="form.jtfs" placeholder="交通方式" />
                        </el-form-item>
                    </el-col> -->
                    <!-- <el-col :span="24">
                        <el-form-item label="费用和价格" prop="fee">
                            <el-input v-model="form.fee" placeholder="费用和价格" />
                        </el-form-item>
                    </el-col> -->
                    <el-col :span="24">
                        <el-form-item label="经纬度" prop="xingcheng">
                            <!-- <el-input  v-model="form.xingcheng1" placeholder="经度" />
                            <el-input v-model="form.xingcheng2" placeholder="纬度" /> -->
                            <el-input-number v-model="form.xingcheng1" :precision="5" :min="1" :max="180"
                                label="经度"></el-input-number>
                            <el-input-number v-model="form.xingcheng2" :precision="5" :min="1" :max="90"
                                label="纬度"></el-input-number>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="注意事项" prop="zhuyi">
                            <el-input type="textarea" :rows="3" v-model="form.zhuyi" placeholder="内容">
                            </el-input>
                        </el-form-item>
                    </el-col>
...
<script>
import { querysysnews, addsysnews, updatesysnews, updatesysnewsstatus, removesysnews } from '@/api/sysapi'
...
export default {
    ...
    data() {
        return {
            ...
            griddata: [
                { prop: 'datetime', label: '发布时间', width: '180' },
                { prop: 'title', label: '路线名称', width: '150' },
                { prop: 'mdd', label: '目的地', width: '130' },
                // { prop: 'fee', label: '费用和价格', width: '130' },
                { prop: 'jtfs', label: '交通方式', width: '150' },
                { prop: 'xingcheng', label: '经纬度信息', width: '250' },
                { prop: 'zhuyi', label: '注意事项', width: '' }
            ],
            tableData: [],
            fileListwl: [],
            multipleSelection: [],
    ...
    methods: {
        ...
        query() {
            ...
            querysysnews(obj).then(res => {
                this.tableData = res.map((val, i) => {
                    ...
                    val.xingcheng2 = 1
                    if (val.xingcheng) {
                        let xingchengArr = val.xingcheng.split(',')
                        if (xingchengArr.length == 2) {
                            val.xingcheng1 = xingchengArr[0] * 1
                            val.xingcheng2 = xingchengArr[1] * 1
                        }
                    }
        ...
        userinfosubmit() {
            ...
            if (this.roleinfotitle == "新增") {
                let objadd = {
                    ...
                    jtfs: this.form.jtfs,
                    fee: this.form.fee,
                    xingcheng: (this.form.xingcheng1 * 1) + "," + (this.form.xingcheng2 * 1),
        ...
        changestatus(index, row) {
            ...
            updatesysnewsstatus(objedit).then(res => {
                this.query()
                this.$message.success('操作成功')
            }).catch(error => {
                // this.$message.error('操作失败')
        ...
        reset() {
            ...
            this.form.fee = ''
            this.form.xingcheng = ''
            this.form.xingcheng1 = 1
            this.form.xingcheng2 = 1
            this.form.zhuyi = ''
            this.fileListwl = []
        }
    },
